...
export default function EditJadwalLatihan({ jadwal }: Props) {
  // Split pukul menjadi waktu_mulai dan waktu_selesai
  const [waktu_mulai, waktu_selesai] = jadwal.pukul.includes(' - ')
    ? jadwal.pukul.split(' - ')
    : [jadwal.pukul, ''];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    put(`/profile/jadwal-latihan/${jadwal.id}`);
  };
